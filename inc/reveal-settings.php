...
function wp_presenter_initialize_script() {
	...
	<script>
		...
		Reveal.initialize({
			...
			keyboard:               <?php if( '' == get_theme_mod( 'keyboard_shortcuts' ) ) { echo 'true'; } else { echo $keyboard; } ?>,
			overview:               <?php if( '' == get_theme_mod( 'overview' ) ) { echo 'false'; } else { echo $overview; } ?>,
			center:                 <?php if( '' == get_theme_mod( 'center' ) ) { echo 'true'; } else { echo $center; } ?>,
			touch:                  <?php if( '' == get_theme_mod( 'touch' ) ) { echo 'true'; } else { echo 'true'; } ?>,
