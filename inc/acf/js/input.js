	...
	*/
	...
	acf.conditional_logic = {
		...
		init : function(){
			...
			// events
			$(document).on('change', '.field input, .field textarea, .field select, .field image_select', function(){
		...
		refresh_field : function( item ){
			...
			$targets.each(function(){
				...
				{
					// remove "disabled"
					$target.find('input, textarea, select, image_select').removeAttr('disabled');
				...
				{
					// add "disabled"
					$target.find('input, textarea, select, image_select').attr('disabled', 'disabled');
